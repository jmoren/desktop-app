      ...
      <el-card>
        <el-form
          ...
          <el-form-item style="text-align: center;">
            <el-button
              style="width: 100%; background: #C70039;color: #fff;"
              @click="doLogin()">Login</el-button>
          </el-form-item>
        </el-form>
        <div class="component">
          {{ connectionMessage }}
          <span :class="{'danger': !connectionOk, 'success': connectionOk}">
            <i :class="{'el-icon-loading': !connectionOk, 'el-icon-success': connectionOk }"></i>
          </span>
        </div>
      </el-card>
      <system-information/>
